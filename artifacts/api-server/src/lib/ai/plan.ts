...
const SYSTEM_INSTRUCTION = [
  ...
  "- tasks: 3 to 6 of them, each ONE focused sitting of 15–60 minutes, in the order they",
  "  should be done (foundational work first). Each task is a concrete action —",
  "  \"Outline the three main arguments\", not \"Work on the essay\". Make them specific to",
  "  this assignment, not generic.",
